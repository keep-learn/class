...
class Face{
    ...
    public $api_key         = 'YOUR API KEY ';        // set your API KEY or set the key static in the property
    public $api_secret      = 'YOUR API SECRET';        // set your API SECRET or set the secret static in the property
